...
int main(int argc, char** argv) {
	...
	int	d_max_gap = 0;	/* Processor 0's max gap	*/
	...
	int	d_prime1;	/* P0 prime 1			*/
	int	d_prime2;	/* P0 prime 2			*/
	...
	if (my_rank == 0) {	
		/* Handling case with 2 processors */
		d_max_gap = max_local_gap;
		d_prime1 = l_prime1;
		d_prime2 = l_prime2;
